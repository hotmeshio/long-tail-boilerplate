...
class ComputeStack extends cdk.Stack {
    constructor(scope, id, props) {
        ...
        const { vpc, dbSecret, albSecurityGroup, appSecurityGroup, workerSecurityGroup, bucket, jwtSecret, oauthSecret, apiKeysSecret, anthropicApiKeySecret, openaiApiKeySecret, seedAdminPasswordSecret, certificate, hostedZone, } = props;
